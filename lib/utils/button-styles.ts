...
const variants: Record<ButtonVariant, string> = {
  primary: "bg-ink text-cream hover:bg-amber-dark",
  // bg-amber (not amber-dark) fails WCAG AA for cream text at this size — use amber-dark.
  secondary: "bg-amber-dark text-cream hover:bg-ink",
